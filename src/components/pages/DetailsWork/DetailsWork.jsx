    ...
    return (
        <div className="">
            <div className="container">
                ...
                <div className='d-flex justify-content-space-between description mt-5'>
                    <div className="mission-badge">
